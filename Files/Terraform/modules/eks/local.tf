locals {
  ...
  workers_group_defaults_defaults = {
    ...
    instance_refresh_min_healthy_percentage  = 180                                                  # The amount of capacity in the ASG that must remain healthy during an instance refresh, as a percentage of the ASG's desired capacity.
